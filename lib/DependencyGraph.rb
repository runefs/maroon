...
if (self_method_definition.length > (index + 1)) then
  ...
  self_method_definition[index]
   ...
   def self_method_ast() AbstractSyntaxTree.new(self_method_body, InterpretationContext.new(methods, {}, {}, Role.new(role_name, 51, "C:/Users/Rune/Documents/GitHub/Moby/base/dependency_graph.rb"), {}))
 end
